...
import za.co.varstycollege.st1009749.campusconnect__v1.databinding.FragmentAssessmentAppealsBinding
import java.text.SimpleDateFormat
import java.util.*

class AssessmentAppealsFragment : Fragment() {
    private var _binding: FragmentAssessmentAppealsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAssessmentAppealsBinding.inflate(inflater, container, false)
    ...
    private fun setInputsEnabled(enabled: Boolean) {
        binding.apply {
            ...
            // Input fields
            currentMarkInput.isEnabled = enabled
    ...
    private fun fetchStudentDetails() {
        ...
        db.collection("StudentModules")
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    try {
                        ...
                        Log.e("AssessmentAppealsFragment", "Error parsing data: ${e.message}", e)
            ...
            .addOnFailureListener { e ->
                Log.e("AssessmentAppealsFragment", "Error fetching document: ${e.message}", e)
    ...
    private fun submitForm() {
        binding.apply {
            ...
            val currentMark = currentMarkInput.text.toString()
            ...
            when {
                ...
                currentMark.isEmpty() -> {
                    Toast.makeText(context, "Please enter your current mark", Toast.LENGTH_SHORT).show()
                }
                assessmentDate.isEmpty() -> {
                    Toast.makeText(context, "Please select the assessment date", Toast.LENGTH_SHORT).show()
                }
                explanation.isEmpty() -> {
                    ...
                    val queryData = hashMapOf(
                        ...
                        "reason" to reason,
                        "currentMark" to currentMark,
                        "assessmentDate" to assessmentDate,
                        "description" to explanation,
                        "supportingDocs" to selectedDocsFileName,
                        "queryName" to (arguments?.getString("queryTitle") ?: "Assessment Appeal Request"),
                        "queryCategory" to "Student Hub Queries",
                        "queryType" to "Assessment Appeal",
                        "status" to "Pending",
    ...
    companion object {
        ...
        fun newInstance(queryTitle: String) = AssessmentAppealsFragment().apply {
