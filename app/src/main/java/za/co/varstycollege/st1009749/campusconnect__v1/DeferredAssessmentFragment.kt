...
import za.co.varstycollege.st1009749.campusconnect__v1.databinding.FragmentDeferredAssessmentBinding
import java.text.SimpleDateFormat
import java.util.*

class DeferredAssessmentFragment : Fragment() {
    private var _binding: FragmentDeferredAssessmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDeferredAssessmentBinding.inflate(inflater, container, false)
    ...
    private fun setupDatePicker() {
        binding.assessmentDateInput.setOnClickListener {
            ...
            val materialDateBuilder = MaterialDatePicker.Builder.datePicker().apply {
                setTitleText("Select Original Assessment Date")
    ...
    private fun fetchStudentDetails() {
        ...
        db.collection("StudentModules")
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    try {
                        ...
                        Log.e("DeferredAssessmentFragment", "Error parsing data: ${e.message}", e)
            ...
            .addOnFailureListener { e ->
                Log.e("DeferredAssessmentFragment", "Error fetching document: ${e.message}", e)
        ...
        binding.apply {
            ...
            when {
                ...
                assessmentDate.isEmpty() -> {
                    Toast.makeText(context, "Please select the original assessment date", Toast.LENGTH_SHORT).show()
                }
                explanation.isEmpty() -> {
                    ...
                    val queryData = hashMapOf(
                        ...
                        "queryName" to (arguments?.getString("queryTitle") ?: "Deferred Assessment Request"),
                        "queryCategory" to "Student Hub Queries",
                        "queryType" to "Deferred Assessment",
                        "status" to "Pending",
...
companion object {
    ...
    fun newInstance(queryTitle: String) = DeferredAssessmentFragment().apply {
