...
import za.co.varstycollege.st1009749.campusconnect__v1.databinding.FragmentIncreasedCreditLoadBinding

class IncreasedCreditLoadFragment : Fragment() {
    private var _binding: FragmentIncreasedCreditLoadBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentIncreasedCreditLoadBinding.inflate(inflater, container, false)
    ...
    private fun setInputsEnabled(enabled: Boolean) {
        binding.apply {
            ...
            // Input fields
            currentCreditsInput.isEnabled = enabled
    ...
    private fun fetchStudentDetails() {
        ...
        db.collection("StudentModules")
                ...
                if (document.exists()) {
                    try {
                        binding.apply {
                            ...
                            currentCreditsInput.setText(document.getString("currentCredits") ?: "")
                        }
                        ...
                        Log.e("IncreasedCreditLoadFragment", "Error parsing data: ${e.message}", e)
            ...
            .addOnFailureListener { e ->
                Log.e("IncreasedCreditLoadFragment", "Error fetching document: ${e.message}", e)
    ...
    private fun submitForm() {
        binding.apply {
            ...
            val currentCredits = currentCreditsInput.text.toString()
            ...
            when {
                ...
                currentCredits.isEmpty() -> {
                    Toast.makeText(context, "Please enter your current credits", Toast.LENGTH_SHORT).show()
                }
                ...
                explanation.isEmpty() -> {
                    ...
                    val queryData = hashMapOf(
                        ...
                        "currentCredits" to currentCredits,
                        "reason" to reason,
                        "description" to explanation,
                        "supportingDocs" to selectedDocsFileName,
                        "queryName" to (arguments?.getString("queryTitle") ?: "Increased Credit Load Request"),
                        "queryCategory" to "Student Hub Queries",
                        "queryType" to "Increased Credit Load",
                        "status" to "Pending",
    ...
    companion object {
        ...
        fun newInstance(queryTitle: String) = IncreasedCreditLoadFragment().apply {
