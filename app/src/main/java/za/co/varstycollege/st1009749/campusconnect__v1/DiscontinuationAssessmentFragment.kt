...
import za.co.varstycollege.st1009749.campusconnect__v1.databinding.FragmentDiscontinuationAssessmentBinding
import java.text.SimpleDateFormat
import java.util.*

class DiscontinuationAssessmentFragment : Fragment() {
    private var _binding: FragmentDiscontinuationAssessmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDiscontinuationAssessmentBinding.inflate(inflater, container, false)
    ...
    private fun fetchStudentDetails() {
        ...
        db.collection("StudentModules")
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    try {
                        ...
                        Log.e("DiscontinuationAssessmentFragment", "Error parsing data: ${e.message}", e)
            ...
            .addOnFailureListener { e ->
                Log.e("DiscontinuationAssessmentFragment", "Error fetching document: ${e.message}", e)
        ...
        binding.apply {
            ...
            when {
                ...
                assessmentDate.isEmpty() -> {
                    Toast.makeText(context, "Please select an assessment date", Toast.LENGTH_SHORT).show()
                }
                explanation.isEmpty() -> {
                    ...
                    val queryData = hashMapOf(
                        ...
                        "queryName" to (arguments?.getString("queryTitle") ?: "Discontinuation/Assessment Request"),
                        "queryCategory" to "Student Hub Queries",
                        "queryType" to "Discontinuation Assessment",
                        "status" to "Pending",
    ...
    companion object {
        ...
        fun newInstance(queryTitle: String) = DiscontinuationAssessmentFragment().apply {
