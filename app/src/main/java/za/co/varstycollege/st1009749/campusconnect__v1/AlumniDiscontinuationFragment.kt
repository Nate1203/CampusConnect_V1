...
import za.co.varstycollege.st1009749.campusconnect__v1.databinding.FragmentAlumniDiscontinuationBinding
import java.text.SimpleDateFormat
import java.util.*

class AlumniDiscontinuationFragment : Fragment() {
    private var _binding: FragmentAlumniDiscontinuationBinding? = null
    ...
    companion object {
        ...
        fun newInstance(queryTitle: String) = AlumniDiscontinuationFragment().apply {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAlumniDiscontinuationBinding.inflate(inflater, container, false)
    ...
    private fun setupDatePicker() {
        binding.lastAttendanceDateInput.setOnClickListener {
            if (!it.isEnabled) {
            ...
            val materialDateBuilder = MaterialDatePicker.Builder.datePicker().apply {
                setTitleText("Select Last Date of Attendance")
            ...
            datePicker.addOnPositiveButtonClickListener { selection ->
                ...
                binding.lastAttendanceDateInput.setText(dateFormat.format(calendar.time))
            }
    ...
    private fun setInputsEnabled(enabled: Boolean) {
        binding.apply {
            ...
            // Input fields
            lastAttendanceDateInput.isEnabled = enabled
    ...
    private fun fetchStudentDetails() {
        ...
        db.collection("StudentModules")
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    try {
                        ...
                        Log.e("AlumniDiscontinuationFragment", "Error parsing data: ${e.message}", e)
            ...
            .addOnFailureListener { e ->
                Log.e("AlumniDiscontinuationFragment", "Error fetching document: ${e.message}", e)
    ...
    private fun submitForm() {
        binding.apply {
            ...
            val lastAttendanceDate = lastAttendanceDateInput.text.toString()
            ...
            when {
                ...
                lastAttendanceDate.isEmpty() -> {
                    Toast.makeText(context, "Please select your last date of attendance", Toast.LENGTH_SHORT).show()
                }
                explanation.isEmpty() -> {
                    ...
                    val queryData = hashMapOf(
                        ...
                        "reason" to reason,
                        "lastAttendanceDate" to lastAttendanceDate,
                        "description" to explanation,
                        "supportingDocs" to selectedDocsFileName,
                        "queryName" to (arguments?.getString("queryTitle") ?: "Alumni Discontinuation Request"),
                        "queryCategory" to "Alumni Student Queries",
                        "queryType" to "Alumni Discontinuation",
                        "status" to "Pending",
    ...
    private fun clearFields() {
        binding.apply {
            ...
            lastAttendanceDateInput.setText("")
